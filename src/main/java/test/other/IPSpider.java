...
//    private final String HTTPS_API = "https://www.kuaidaili.com/free/intr/";
//    private final String HTTP_API = "https://www.kuaidaili.com/free/intr/";
    ...
    private List<IPBean> web1(String api, int index){
        String html = HttpUtils.getResponseContent(api+index);
        System.out.println(html);
        ...
        try {
            ...
            elements.forEach((v) -> {
                ...
                IPBean ip=new IPBean(address,port,0);
                ipList.add(ip);
            });
        } catch (Exception e) {
